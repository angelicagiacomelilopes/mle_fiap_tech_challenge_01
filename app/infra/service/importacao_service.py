...
import json
from data.importacao_backup import json_str
...
class ImportacaoService:
    ...
    def get_data(self, year: Optional[int] = None, tipo: Optional[str] = None, 
        ...
        url_teste = "http://vitibrasil.cnpuv.embrapa.br/index.php?opcao=opt_05"
            ...
            try:
                if year is not None:
                    ...
                    if tipo is not None:
                        ...
                        url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_05&subopcao=subopt_{valor}"
                        ...
                        for tipo_nome, tipo_cod in dict_tipo.items(): 
                            url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_05&subopcao=subopt_{tipo_cod}"
                    ...
                    for ano in range(1970, 2024):
                        for tipo_nome, tipo_cod in dict_tipo.items(): 
                            url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={ano}&opcao=opt_05&subopcao=subopt_{tipo_cod}"
                            try:
                ...
                for tipo, tipo_group in ano_group.groupby('Tipo'):
                    ...
                    for _, row in tipo_group.iterrows():
                        ...
                        paises_data[pais] = {
                            ...
                            "valor": row.get('Valor', 'N/A')  # Valor é opcional
                        }
